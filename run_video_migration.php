<?php
/**
 * Video Management Migration Script
 * Run this once to set up video tables
 */

require_once __DIR__ . '/includes/db.php';

echo "Starting video management migration...\n";

try {
    // Create videos table without foreign key initially
    $pdo->exec("
    ...
    ");
    echo "✓ Created 'video_watch_history' table\n";
    ...
    ");
    echo "✓ Created 'video_ratings' table\n";
    ...
    ");
    echo "✓ Inserted sample videos\n";

    echo "\n✅ Video management migration completed successfully!\n";
    echo "\n📝 Summary:\n";
    echo "  - Videos table: 5 sample videos\n";
    echo "  - Watch history table: Ready for tracking student progress\n";
    echo "  - Ratings table: Ready for student feedback\n";
    echo "\n🎬 Admin: http://localhost/EXAMs/admin/videos/list.php\n";
    echo "📹 Student: http://localhost/EXAMs/student/video_streaming.php\n";
